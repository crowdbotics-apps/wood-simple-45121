"""
Django settings for wood_simple_45121 project.
...
ROOT_URLCONF = 'wood_simple_45121.urls'
...
WSGI_APPLICATION = 'wood_simple_45121.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wood_simple_45121 API",
    "DESCRIPTION": "API documentation for wood_simple_45121 App",
    "VERSION": "v1",
}
